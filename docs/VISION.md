...
- **工具能力**（Phase 2a）：浏览器控制、文件操作、代码执行、Skills 框架。工具能力优先于新渠道（DEC-027）
- **中国特色工具**（Phase 2b）：快递、天气、农历日历、翻译、汇率、热搜
- **语音**（Phase 3）：ASR/TTS（讯飞/阿里）、Talk Mode
- **安全**（贯穿所有阶段）：内容审核、数据加密、沙箱隔离、Owner 认证（DEC-026）
